...
#Updating 1 (overriding say_hi() and adding extra method in child class)
import random
...
#------Update-2-----------------------------------------------
#sometimes we want to reuse the method of the parent class and add some new stuff
